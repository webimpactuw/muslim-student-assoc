            ...
            <div className="grey-bg">
                ...
                <div className="grid-col">
                    ...
                    <div className="involved-elmt">
                        ...
                        <p>
                            Attend our general meetings, quarterly events, IH Jummah, social events, and other activities. 
                            This is the best chance for you to meet other Muslims on campus, get involved in engaging activities, 
                    ...
                    <div className="involved-elmt">
                        ...
                        <p>
                            Membership is free and is available to all UW Muslim students, both undergraduate and graduate. 
                            Membership will allow you to have a say in how MSA is run, attend MSA town halls, run for office, 
                    ...
                    <div className="involved-elmt">
                        ...
                        <p>
                            If you want to work towards advancing MSA’s cause on campus, bettering Muslim life on campus, 
                            and get engaged in meaningful service, run for an MSA Officer position!                        
                        </p>
                        <p>
                            MSA is an organization that needs to grow in order to thrive. 
                            By having new leadership year after year, Officers are able to build upon the successes of previous Boards. 
                        </p>
                        <p>
                            If you don’t want to run, come and vote in elections! 
